...
p.add_argument('-s', '--source', required = True, type=str, default=Path.cwd() / 'music')
p.add_argument('-d', '--destination', type=str, default=pathlib.Path.cwd() / 'music' / 'mix.mp3')
p.add_argument('-c', '--count', type=int, default=len(mp3_files))
p.add_argument('-f', '--frame', type=int, default=10)
p.add_argument('-l', '--log', type=str, default='', action = 'store_true')
p.add_argument('-e', '--extended', type=str, default='', action = 'store_true')
args = p.parse_args()
...
def main(source, destination, count, frame, log, extended):
...
if __name__ == '__main__':
    main(args.source, args.destination, args.count, args.frame, args.log, args.extended)